          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              <div>
                ...
                <h1 className="text-3xl font-bold">Teh Rempah Kemangi</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Ocimumbasilicum nama latin dari daun kemangi yang artinya
                tumbuhan beraroma khas yang keluar dari daun kemangi. di
                indonesia sendiri kemangi lebih sering dimanfaatkan sebagai
                pelengkap makanan untuk menambah aroma dan menggugah selera,
                seperti pepes, lalapan, sayur, dll.
              </p>
...
export default TehRempahKemangi;
