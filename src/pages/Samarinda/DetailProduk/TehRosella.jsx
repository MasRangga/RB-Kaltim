           ...
           <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
             ...
             <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
               <div>
                 ...
                 <h1 className="text-3xl font-bold">Teh Rosella</h1>
               </div>
               <p className="text-gray-700 leading-relaxed">
                 Hibiscus sabdariffa yang merupakan nama latin dari Bunga
                 Rosella merupakan species bunga yang berasal dari benua afrika,
                 yang mulanya bunga cantik ini untuk dijadikan penghias halaman
                 rumah saja, dan kedepannya dijadikan minuman penghangat badan
                 saat cuaca dingin dan menyegarkan badan saat cuaca panas.
               </p>
