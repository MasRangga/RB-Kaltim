          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              ...
              <p className="text-gray-700 leading-relaxed">
                Eleutherine palmifolia nama latin dari bawang dayak (Bawang
                Tiwai, Bawang Bromot, Bawang Sebrang, Bawang Berlian). Secara
                turun temurun suku dayak sudah membudidayakannya sampai sekarang
                karna kandungan vitamin dan manfaatnya yang sangat luar biasa
                untuk kesehatan tubuh kita. misalnya pengeroposan tulang,
                kanker, ginjal, anti bakteri, dll.
              </p>
