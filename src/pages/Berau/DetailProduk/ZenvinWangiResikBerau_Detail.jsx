...
const ZenvinWangiResikBerau_Detail = () => {
  const [images, setImages] = useState({
    img1: ZenvinWangiResikBerau,
  });
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              <div>
                ...
                <h1 className="text-3xl font-bold">Wangi Resik</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Minuman Herbal dari Kunyit Kunci Daun Sirih Bermanfaat untuk
                mencegah Bau Badan, Bau Mulut. Mencegah Sariawan dapat diminum
                Pria dan Wanita
              </p>
...
export default ZenvinWangiResikBerau_Detail;
