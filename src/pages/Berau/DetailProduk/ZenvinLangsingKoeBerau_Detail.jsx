...
const ZenvinLangsingKoeBerau_Detail = () => {
  const [images, setImages] = useState({
    img1: ZevinLangsingokeBerau,
  });
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              <div>
                ...
                <h1 className="text-3xl font-bold">Langsing Koe</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Minuman siap minum Produk tersebut dapat membantu meningkatkan
                metabolisme tubuh, membantu dalam pembakaran kalori lebih
                efisien. Dapat sebagai Pengurangan Nafsu Makan, Peningkatan
                Energi, dan Penurunan Lemak. Terbit izin BPOM, HALAL , HKI dan
                lolos Laboratorium.
              </p>
...
export default ZenvinLangsingKoeBerau_Detail;
