...
const ZenvinManjabuanaBerau_Detail = () => {
  const [images, setImages] = useState({
    img1: ZenvinManjabuanaBerau,
  });
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              <div>
                ...
                <h1 className="text-3xl font-bold">Manjabuana Berau</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Minuman herbal ready to drink dari Manjakani, Kunyit, Jahe,
                Madu, Kunyit putih mangga, dapat membantu merawat dan menjaga
...
export default ZenvinManjabuanaBerau_Detail;
