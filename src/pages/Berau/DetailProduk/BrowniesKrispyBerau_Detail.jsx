...
const BrowniesKrispyBerau_Detail = () => {
  const [images, setImages] = useState({
    img1: BrowniesKrispyBerau,
  });
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              <div>
                ...
                <h1 className="text-3xl font-bold">Brownies Krispy</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Brownies Krispy coklat khas Berau ini dibuat dengan bahan baku
                coklat asli dari Berau, yang terkenal akan kualitas dan cita
                rasanya yang khas. Dibuat dengan perpaduan coklat Berau yang
                rich dan lembut, brownies ini memiliki tekstur renyah di bagian
                atas dan tetap moist di bagian dalamnya.
              </p>
...
export default BrowniesKrispyBerau_Detail;
