...
const SambalIkanBerau_Detail = () => {
  const [images, setImages] = useState({
    img1: SambalIkanBerau,
  });
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              <div>
                ...
                <h1 className="text-3xl font-bold">Sambal Ikan Cabe Hijau</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Sambal ikan cabai hijau ini dibuat dengan bahan baku lokal
                pilihan, menggunakan ikan segar sebagai bahan utama yang diolah
                bersama cabai hijau yang pedas dan aromatik. Ditambah dengan
                sentuhan terasi khas Berau yang memiliki cita rasa unik, sambal
                ini menghadirkan perpaduan rasa gurih, pedas, dan sedikit
                smokey.
              </p>

              <p className="text-gray-700">
                {" "}
                <span className="font-semibold">Berat Bersih : </span> 130gr
              </p>
              <h6 className="text-2xl font-semibold">Rp. 30.000</h6>
...
export default SambalIkanBerau_Detail;
