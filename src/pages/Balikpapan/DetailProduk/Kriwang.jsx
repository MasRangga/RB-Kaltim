          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              <div>
                ...
                <h1 className="text-3xl font-bold">Kriwang</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Makanan ringan yang terbuat dari tepung dengan bahan tambahan
                lainnya yang berkualitas serta bawang merah .kripik ini
                mempunyai cita rasa gurih dan renyah sehingga sanggat cocok di
                konsumsi untuk semua orang yang suka ngemil. Kripik ini
                mempunyai 3 varian yaitu original, pedas dan udang.
              </p>
              <p className="text-gray-700">
                {" "}
                <span className="font-semibold">Komposisi : </span> Tepung
                Teligu, Tepung Tapioka, Telur, Mentega, Penyedap Rasa, Seledri,
                Bawang Merah.
              </p>
              <p className="text-gray-700">
                {" "}
              ...
              <h6 className="text-2xl font-semibold">Rasa Udang Rp. 25.000</h6>
              <h6 className="text-2xl font-semibold">Rasa Pedas Rp. 13.000</h6>
