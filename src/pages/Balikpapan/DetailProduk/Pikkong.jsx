        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              <div>
                <span className="text-primary font-semibold">Pikkong</span>
                <h1 className="text-3xl font-bold">Keripik Singkong Pedas</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Keripik singkong pedas dengan tingkat kepedasan bervariasi.
                Tersedia dalam 3 varian rasa: pedas original, pedas keju, dan
                pedas level 5.
              </p>
              <p className="text-gray-700">
                {" "}
                <span className="font-semibold">Komposisi : </span> Singkong,
                Minyak, Cabai, Bawang, Gula, Garam.
              </p>
              <p className="text-gray-700">
                {" "}
                <span className="font-semibold">Berat Bersih : </span> 120 gr
              </p>
              <h6 className="text-2xl font-semibold">Rp. 16-17.000</h6>
