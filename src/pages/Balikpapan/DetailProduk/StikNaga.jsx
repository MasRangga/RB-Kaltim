          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              <div>
                ...
                <h1 className="text-3xl font-bold">Stik Naga</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Stik yang terbuat dari buah naga pilihan yang merupakan salah
                satu kearifan lokal Balikpapan yang memiliki tekstur yang renyah
                dan gurih, kandungan vitamin dan mineral yang terkandung dibuah
                naga sangat baik untuk kesehatan tubuh.
              </p>
              <p className="text-gray-700">
                {" "}
                <span className="font-semibold">Komposisi : </span> Tepung
                Terigu, Tepung Tapioka, Margarin, Telur, Buah Naga, Penyedap,
                Gula, Garam.
              </p>
              <p className="text-gray-700">
                {" "}
