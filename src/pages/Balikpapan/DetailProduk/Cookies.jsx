          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              ...
              <p className="text-gray-700 leading-relaxed">
                Kue kering dengan rasa manis dan gurih yang sangat digemari
                mulai dari anak-anak hingga orang tua. Kue ini wajib ada saat
                lebaran.
              </p>
              <p className="text-gray-700">
                {" "}
                <span className="font-semibold">Komposisi : </span> Tepung
                Terigu, Gula, Telur, Susu, Mentega, Butter, dll.
              </p>
              <p className="text-gray-700">
                {" "}
                <span className="font-semibold">Berat Bersih : </span> 25 gr,
                500 gr, 1000 gr.
              </p>
              <h6 className="text-2xl font-semibold">Rp. 35-150.000</h6>
