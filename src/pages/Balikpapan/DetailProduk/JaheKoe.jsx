          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              ...
              <div>
                ...
                <h1 className="text-3xl font-bold">Jahe Koe</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Jahekoe merupakan minuman herbal serbuk instan terbuat dari
                bahan-bahan alami tanpa pengawet dan pemanis buatan. Sangat
                praktis dalam penyajiannya, tinggal seduh dengan air panas saja.
                Jahekoe dikemas dalam botol plastik yang dapat digunakan ulang
                untuk mengurangi sampah plastik. Tersedia dalam 5 varian rasa:
                Jahe Merah + Serai, Jahe Merah + Kencur, Kunyit + Jahe Merah,
                Kunyit Asem, dan Kunyit Sirih.
              </p>
              <p className="text-gray-700">
                <span className="font-semibold">Komposisi : </span> Jahe Merah,
                Kunyit, Kencur, Asem Jawa, Daun Sirih, Gula Pasir, dan Gula
                Aren.
              </p>
              <p className="text-gray-700">
                <span className="font-semibold">Berat Bersih : </span> 200 gr
              </p>
