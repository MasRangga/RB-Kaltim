        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              <div>
                <span className="text-primary font-semibold">Nikimie</span>
                <h1 className="text-3xl font-bold">Black Gartic</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Produk utama kami adalah bawang hitam yang dipasarkan dengan
                nama Bawang Hitam Nikimie. Bawang hitam ini diolah dari bawang
                putih tunggal dengan proses karamelisasi dalam waktu dan suhu
                tertentu. Keunggulan Nikimie diproses secara higienis dengan
                suhu dan waktu tertentu tanpa pengawet dan pewarna. Proses ini
                menyebabkan perubahan warna hitam dengan tekstur yang lembut dan
                kenyal serta rasa yang manis asam dan tidak berbau, tidak getir
                ataupun pedas seperti bawang putih pada umumnya. Bawang hitam
                mengandung anti oksidan 2X lipat dibanding bawang putih.
              </p>
              <p className="text-gray-700">
                {" "}
                <span className="font-semibold">Komposisi : </span> Bawang Hitam
                antara lain mengandung Polifenol, Flavonoid, Alkaloid, dan
                S-allylcysteine
              </p>
            
              <h6 className="text-2xl font-semibold">Rp. 125.000</h6>
