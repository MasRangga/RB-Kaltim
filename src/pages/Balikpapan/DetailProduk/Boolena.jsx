          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              <div>
                ...
                <h1 className="text-3xl font-bold">Boolena Balikpapan</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Bollena Balikpapan adalah kue Bollen Pastry yang memiliki cita
                rasa yang enak dan manisnya pas, dengan tekstur kulit yang
                lembut dan berlapis. Isiannya sangat melimpah dan toppingnya
                juga berlimpah. Terdapat enam varian isian yang menarik, antara
                lain Smoked Beef Mayo, Piscochiz (pisang, coklat, keju),
                Tapecochiz (tape, coklat, keju), Apple Caramel, Durian, dan
                Pineapple Raisin.
              </p>
              <p className="text-gray-700">
                {" "}
                <span className="font-semibold">Komposisi : </span> Tepung
                Terigu, Butter, Margarin, Keju, Filling Coklat, Telur, Meses
              </p>
              <p className="text-gray-700">
                {" "}
                <span className="font-semibold">Berat Bersih : </span> 750 gr
              </p>
              <h6 className="text-2xl font-semibold">Rp. 95.000/Box</h6>
