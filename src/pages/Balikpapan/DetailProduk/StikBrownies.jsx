          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              <div>
                ...
                <h1 className="text-3xl font-bold">Stik Brownies</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Mangrove Stick Brownies terbuat dari serbuk buah mangrove jenis
                Rhizophora mucronata yang tumbuh di kawasan Mangrove Center
                Graha Indah, Balikpapan - Kalimantan Timur. Brownies stick ini
                merupakan pilihan yang populer karena ukurannya yang praktis dan
                mudah dibawa, serta memberikan pengalaman menikmati brownies
                dengan cara yang sedikit berbeda dari biasanya.
              </p>
              <p className="text-gray-700">
                {" "}
                <span className="font-semibold">Komposisi : </span> Serbuk
                Mangrove, Tepung. Telur, Butter, Gula, Coklat Batang, Coklat
                bubuk
              </p>
              <p className="text-gray-700">
                {" "}
