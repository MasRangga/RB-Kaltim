        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              <div>
                <span className="text-primary font-semibold">Linda Zizha</span>
                <h1 className="text-3xl font-bold">Kembang Goyang</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Keripik jajanan jadul berbahan baku tepung beras, memiliki rasa
                sedikit manis, gurih, garing, dan renyah. Tersedia dalam varian
                rasa original dan wijen.
              </p>
              <p className="text-gray-700">
                {" "}
                <span className="font-semibold">Komposisi : </span> Tepung
                Beras, Tepung Terigu, Maizena, Gula, Telur, Santan, dan Garam.
              </p>
              <p className="text-gray-700">
                {" "}
                <span className="font-semibold">Berat Bersih : </span> 50 dan
                100gr
              </p>
              <h6 className="text-2xl font-semibold">Rp. 12-17.000</h6>
