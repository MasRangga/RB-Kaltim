          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              ...
              <p className="text-gray-700 leading-relaxed">
                Mucrova Kopi Mangrove Drink adalah kopi mangrove siap minum yang
                tersedia dalam berbagai macam rasa, yaitu Zero Sugar, Creamy,
                Sweety, Hazelnut, dan Caramel.
              </p>
              <p className="text-gray-700">
                {" "}
                <span className="font-semibold">Berat Bersih : </span> 250ml
              </p>
              <h6 className="text-2xl font-semibold">Rp. 12.000</h6>
              {/* WhatsApp Button */}
