        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              <div>
                <span className="text-primary font-semibold">Sien Pongoh</span>
                <h1 className="text-3xl font-bold">Oshien</h1>
              </div>
              ...
              <p className="text-gray-700">
                ...
                air. <br />  Keripik Pisang Manis: Pisang (tanduk atau kepok), minyak
                goreng, madu, gula pasir, garam, air.
              </p>
              <p className="text-gray-700">
                {" "}
