        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:items-center justify-between">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 lg:mr-20">
              ...
              <div>
                <span className="text-primary font-semibold">RirTri Kueku</span>
                <h1 className="text-3xl font-bold">IniBrownies</h1>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Kue kering brownies cookies adalah kue kering dengan tekstur
                yang padat mirip brownies dan cita rasa cookies.
              </p>
              <p className="text-gray-700">
                <span className="font-semibold">Komposisi : </span> Tepung
                Terigu, Gula Halus, Coklat DCC, Coklat Bubuk, Margarin, Telur,
                Baking Powder, Vanili.
              </p>
              <p className="text-gray-700">
                <span className="font-semibold">Berat Bersih : </span> 70 gr
              </p>
              <h6 className="text-2xl font-semibold">Rp. 20.000</h6>
